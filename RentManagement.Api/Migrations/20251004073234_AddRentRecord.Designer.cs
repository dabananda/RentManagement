...
namespace RentManagement.Api.Migrations
{
    ...
    [Migration("20251004073234_AddRentRecord")]
    partial class AddRentRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentManagement.Api.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RentManagement.Api.Models.RentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RentManagement.Api.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RentManagement.Api.Models.RentRecord", b =>
                {
                    b.HasOne("RentManagement.Api.Models.RentalAgreement", "Agreement")
                        .WithMany()
